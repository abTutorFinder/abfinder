    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-7 col-lg-7 col-xs-12">
            <center>
              <br>
              <img src="<?php echo e(asset('images/boy.png')); ?>" style="width: 580px">
            </center>
          </div>
      </div>
    </div>
...
<script type="text/javascript">
  $("form#stdSignup").submit(function(e) {
    ...
    $(".error_msg").html("");
      ...
      e.preventDefault();
      $.ajax({
          url: "<?php echo e(route('stdSignup')); ?>",
          type: "POST",
          data: form_data,
          async: false,
...
</script> <script src="<?php echo e(asset('js/intlTelInput.min.js')); ?>"></script>
