...
<style type="text/css">
  body{
    background-image: url('{{asset("")}}/images/repeat.jpg');
  }
</style>
<!-- Modal -->
                                    ...
                                    <!-- profile Image -->
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-md-7 col-lg-7 col-xs-12">
                                                <div class="form-group">
                                                   <a class="popupImage" rel="group1" id="profile_image_a" href="{{asset('images/demo.jpg')}}"><img id="profile_image_preview" src="{{asset('images/demo.jpg')}}" alt="" style="height: 152px" />
                                                  </a>
                                              </div>
                                            </div>
                                      ...
                                      <center>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xs-12">
                                              ...
                                              <a class="popupImage" rel="group1" id="media1_a" href="{{asset('images/demo.jpg')}}"><img id="media1_preview" src="{{asset('images/demo.jpg')}}" alt="" style="width: 100%;height: 124px" />
                                              </a>
                                               <div class="upload-btn-wrapper">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-xs-12">
                                              ...
                                              <a class="popupImage" rel="group1" id="media2_a" href="{{asset('images/demo.jpg')}}"><img id="media2_preview" src="{{asset('images/demo.jpg')}}" alt="" style="width: 100%;height: 124px" />
                                              </a>
                                               <div class="upload-btn-wrapper">
                                                <button class="btn half" style="width: 100% !important">Upload a file</button>
...
<script type="text/javascript">
  $(document).ready(function(){
     $('#Cvpreview').html("<img src='{{asset('')}}images/demo.jpg' width='100%' style='height:200px' />");
     $('#awardPreview').html("<img src='{{asset('')}}images/demo.jpg' width='100%' style='height:200px' />");
  });
   ...
   function mediaPrview(value){
      ...
      //e.preventDefault();
      $.ajax({
          url: "{{route('PreviewMedia')}}",
          type: "POST",
          data: form_data,
          async: false,
          success: function (msg) {
            if(msg!=""){
              $('#'+value+'').html("<a href='{{asset('')}}"+msg+"' style='display:block'><object width='100%' height='200px'  data='{{asset('')}}"+msg+"'></object></a>");
            }
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#profile_image_preview").attr('src','{{asset('')}}images/profile.png');
