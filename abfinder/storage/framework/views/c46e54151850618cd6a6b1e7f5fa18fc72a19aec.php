		...
		<div class="GridLex-grid-noGutter-equalHeight">
			...
			<div class="GridLex-col-6_sm-8_xs-12_xss-12">
				...
				<ul class="address-list">
					...
					<li><i class="fa fa-money-bill-alt icon"></i> <b style="color: green">$<?php echo e($data->price1); ?></b> For 30min </li>
					<li><i class="fa fa-money-bill-alt icon"></i> <b style="color: green">$<?php echo e($data->price2); ?></b> For 45min </li>
					<li><i class="fa fa-money-bill-alt icon"></i> <b style="color: green">$<?php echo e($data->price3); ?></b> For 60min </li>
				</ul>
