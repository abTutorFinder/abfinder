																...
																<div class="col-xs-12 col-sm-12 col-md-12">
																	...
																	<div class="form-group">
																		...
																		<?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																			<option  value="<?php echo e($group['subjectname']); ?>"><?php echo e($group['subjectname']); ?></option>
																			<?php $__currentLoopData = $group["subgroup"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subgroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																				...
																				<option value="<?php echo e($subgroup['title']); ?>">
											...
											<div class="row gap-20">
												...
												<div class="col-xs-12 col-sm-3 col-md-2">
													...
													<div class="image" style="width: 100px;height: 100px">
														<img src="<?php echo e(asset($profile->profile)); ?>" style="width: 100px;height: 100px"  alt="Image" />
													</div>
												...
												<div class="col-xs-12 col-sm-9 col-md-10">
													...
													<div class="content">
														...
														<h3><a href="<?php echo e(asset('')); ?>/tutor/public/<?php echo e($profile->slug); ?>"><?php echo e($profile->name); ?></a> | <span class="labeling" style="margin-bottom: 0px">Music Teacher</span></h3>
														
														<span><?php echo e($profile->services); ?></span><br>
														<b><span class="fa fa-map-marker-alt"></span> Address: &nbsp; <?php echo e($profile->address); ?></b><br>
														<span><span class="fa fa-language"></span> Languages: &nbsp; <?php echo e($profile->language); ?></span><br>
														
														<p class="short-info"><span class="fa fa-user"></span> About: <?php echo e($profile->about); ?></p>
														
														<a href="<?php echo e(asset('')); ?>/tutor/public/<?php echo e($profile->slug); ?>" class="btn btn-primary btn-sm">More about him</a>
...
function searchHere(){
 ...
 window.location.assign("<?php echo e(asset('')); ?>tutor/find-a-tutor/"+subjects);
}
